...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <img src="./img/police3.png"   style="height:500px;"  alt="police">
            <table class="table">
                <thead>
                    <tr>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-danger bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
            <img src="./img/police3.png"   style="height:500px;"  alt="police">
            <h2 class="text-center bg-danger">Evolution of BPRD</h2>
            <div class="h2 bg-warning" style="height:900px;">
                CREATION:</br>
...
### CONTACT US PAGE:
![Contact](./output4.jpeg)
![Contact](./output3.jpeg)
